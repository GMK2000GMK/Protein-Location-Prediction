...
path = "C:\\Users\\gkhan\\Final_coursework\\Data\\protein_info_completed.tsv"
...
# Define the paths to the TSV files
path = "C:\\Users\\gkhan\\coursework\\final\\data\\protein_info_completed_mod.tsv"
...
data.to_csv('C:\\Users\\gkhan\\Final_coursework\\application\\Data\\number_of_occurances.tsv', sep='\t', index=False)
...
with open('C:\\Users\\gkhan\\Final_coursework\\application\\Data\\subcellular_location.csv', 'w', newline='') as file:
...
with open("C:\\Users\\gkhan\\Final_coursework\\application\\Data\\my_file.txt", "w") as file:
...
# with open('C:\\Users\\gkhan\\Final_coursework\\application\\Data\\model_info.txt', 'w') as f:
#     f.write(classification_report(y_test_encoded, y_pred, labels=unique_labels, target_names=label_encoder.inverse_transform(unique_labels), zero_division=1))
...
report_df.to_csv('C:\\Users\\gkhan\\Final_coursework\\application\\Data\\classification_report.csv', index=False)
# Save the trained model to a file
with open('C:\\Users\\gkhan\\Final_coursework\\application\\Data\\trained_model.pkl', 'wb') as f:
    pickle.dump(classifier, f)
    

with open('C:\\Users\\gkhan\\Final_coursework\\application\\Data\\label_encoder.pkl', 'wb') as f:
    pickle.dump(label_encoder, f)

with open('C:\\Users\\gkhan\\Final_coursework\\application\\Data\\vectorizer.pkl', 'wb') as f:
    pickle.dump(vectorizer, f)
# print(unique_labels)
np.save('C:\\Users\\gkhan\\Final_coursework\\application\\Data\\my_array.npy', cm)
